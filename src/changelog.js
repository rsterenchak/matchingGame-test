export const changelog = [
  {
    ...
    changed: [
      ...
      'Nimbus cloud on the home screen now bobs gently up and down instead of tilting as it floats.',
      'Desktop hamburger button now matches the audio button size and yellow styling for a consistent look.',
    ],
    fixed: [
