...
- [ ] **[LOW]** Shift nimbus cloud 10% to the right relative to the background on desktop only
  - Type: feature
  ...
  <!-- id: cfc14173-1078-4bb2-884e-4079b7b285a4 -->
...
- [x] **[LOW]** Add subtle floating animation to `#logoContainer` on mobile viewports
  - Type: feature
